...
public class IatDemo extends Activity implements OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (viewId == R.id.image_iat_set) {
            Intent intents = new Intent(IatDemo.this, IatSettings.class);
            startActivity(intents);
        } else if (viewId == R.id.iat_recognize) {
            // 移动数据分析，收集开始听写事件
        ...
        } else if (viewId == R.id.iat_recognize_stream) {
            executeStream();
        } else if (viewId == R.id.iat_stop) {
            mIat.stopListening();
            showTip("停止听写");
        } else if (viewId == R.id.iat_cancel) {
            mIat.cancel();
            showTip("取消听写");
        } else if (viewId == R.id.iat_upload_contacts) {
            showTip(getString(R.string.text_upload_contacts));
            ContactManager mgr = ContactManager.createManager(IatDemo.this,
                    mContactListener);
            mgr.asyncQueryAllContactsName();
        } else if (viewId == R.id.iat_upload_userwords) {
